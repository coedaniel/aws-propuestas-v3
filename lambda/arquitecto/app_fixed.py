"""
AWS Propuestas v3 - Arquitecto Lambda FIXED
Funcionalidad completa con formato Bedrock correcto
"""
...
def lambda_handler(event, context):
    """Main Lambda handler with CORS support and fixed Bedrock format"""
