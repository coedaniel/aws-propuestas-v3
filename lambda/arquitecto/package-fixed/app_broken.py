...
# MCP Connector for enhanced functionality
...
Documentos generados especificamente para {servicio}:

- Propuesta Ejecutiva - Documento profesional centrado en {servicio}
- Documento Tecnico - Arquitectura especifica de {servicio}

Todos los documentos estan disponibles en la seccion de Proyectos para descarga.

¿Te gustaria que ajuste algun aspecto especifico de la solucion con {servicio}?"""
